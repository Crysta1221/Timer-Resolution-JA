...
scoreboard players set timer_mode timer 1

tellraw @a [{"text":"[","color":"red","bold":true},{"text":"Timer Resolution","color":"yellow","bold":true},{"text":"]","color":"red","bold":true},{"text":" カウントダウンをリセットしました。","color":"red","bold":false}]
